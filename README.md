...
3. Play a song — lyrics should scroll in sync. Tune offsets from the on-screen
   menu or `config.json` (see [Test/README_Pi_Zero_2W.md](Test/README_Pi_Zero_2W.md)
   for every key).
...
keys are in the [Pi Zero 2W guide](Test/README_Pi_Zero_2W.md#word-level-karaoke).
